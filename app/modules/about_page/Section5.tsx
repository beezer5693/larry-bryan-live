...
const storyText = [
  ...
  {
    text: "To add to the mix, my mom had a unique sense of style – at the age of 4, she always dressed me like I was a professor, complete with a suit, bowtie, and wingtip shoes, and then sent me off to preschool like that. You can imagine the first impressions I made! As I navigated through elementary and high school, I was a solid C+ student, if I'm being generous. My friends, on the other hand, were all A+ wizards, but their magical ways were beyond my grasp.",
  },
  {
